...
class StatusCodePages(TestCase):
    ...
    def test_detail_idea_page(self):
        ...
        response = self.client.get('keskon/detail_idea/1/')
        self.assertEqual(response.status_code, 200)
    ...
    def test_edit_idea_page(self):
        ...
        response = self.client.get(reverse('edit_idea', kwargs={'id': 1}))
        self.assertEqual(response.status_code, 200)
        """
        """  
        # TEST FONCTIONNEL
    def test_delete_idea_page(self):
        ...
        response = self.client.get(reverse('delete_idea', kwargs={'id': 1}))
